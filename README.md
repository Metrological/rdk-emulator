...
Import the RDK-emulator.ova into VirtualBox.

In VirtualBox select the RDK-emulator and press start-button in order to boot the emulator. Wait until the opening-page is visible (you will see the title `Comcast Set-Top-Box-Developer-Edition` at the top of the page).
